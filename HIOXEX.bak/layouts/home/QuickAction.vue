<template>
	<view class="quick_action_class">
		...
		<!-- <view class="coin_pool_class">
			<image v-if="getGlobalLang === 'cn'" class="img" @tap="navigateTo('/pages/coin_pool_rules/index')" src="/stat"></image>
		</view> -->
		<view class="coin_pool_class">
			<image class="img" @tap="navigateTo('/pages/pool/index')" :src="`/static/images/pool/${getGlobalLang}.jpg`"></image>
		</view>
	</view>
</template>
