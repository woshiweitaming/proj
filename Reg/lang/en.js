const en = {
	...
	"getVerificationCode": "Acquire verification code",
	...
	"extractingRecords": "Currency withdrawal record",
	"rechargeRecord ": "Charging record",
	...
	"drawithTipsText": "• 1. Withdrawal time is 12:00-24:00 Hong Kong time, and you can submit two withdrawal applications per day (minimum withdrawal 100u, maximum withdrawal 30,000u);4. After submitting the withdrawal application, the arrival time is subject to the block confirmation time. If the withdrawal is not expected after the withdrawal time, please contact customer service for inquiries; ",
	"rechargeTips": "Please do not charge any non USDT_OMNI asset to above address, otherwise the assets cannot be found back. If you have already finished currency charging, please click I have already charged currency  	botton and submitted the information, otherwise charging record will not be booked into account.USDT currency charging only support simple send methhod, 	record from charging method cannot be booked and please understand;After you have charged to above address, account booking can only be effected after confirmation by whole network nodes.Please be assured to confirm the security of computer and browser to prevent information being tampered or leaked ",
    "sp1": "Share",
    "sp2": "QR code sharing",
    "sp3": "View Poster",
    "sp4": "Save QR code",
