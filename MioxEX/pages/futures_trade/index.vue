							...
							<view class="form_label">
								<view class="form_label_main">
									<view class="form_input_bar">
										...
										<input v-else type="number" class="input_bar" :placeholder="getLangs('price')" v-model="form.appointprice" />
									</view>
								</view>
							</view>
							<view class="form_label">
								<view class="form_label_main">
									<view class="form_input_bar">
										...
										<input v-else type="number" class="input_bar" :placeholder="getLangs('numEmptyTips')" v-model="form.num" />
									</view>
								</view>
