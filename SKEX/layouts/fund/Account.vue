<template>
	<view class="account_class">
		...
		<view class="account_list">
			<view v-if="key !== 'type'" class="account_list_label" v-for="(items, key) in getAccountBanlance && getAccountBanlance[getActive]" :key="key">
					...
					<view class="table_hd">
						...
						<view class="table_hd_label">{{getLangs('convert')}}(SGD)</view>
					</view>
					<view class="table_bd">
