<template>
	<view class="trade_btn_class">
		...
		<TradeDialog :opt="opt" ref="tradeDialog" :show="showTradeDialogStatus" :datas="data" @close="closeTradeDialog" />
		<OrderConfirmDialog :show="showOrderConfirmDialogStatus" :data="data" :opt="opt" @close="closeOrderConfirmDialog" />
	</view>
</template>
...
<script>
	...
	import TradeDialog from './trade_dialog.vue'
	import OrderConfirmDialog from './order_confim_dialog.vue'
	export default {
		name: 'TradeBtn',
