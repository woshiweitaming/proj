<template>
	<view class="trade_main_class" @tap="eventClick">
		...
		<view class="trade_fee">
			<view class="trade_fee_label">{{getLangs('fee')}}: {{getCurrentCurrencyData && getCurrentCurrencyData.attach && getCurrentCurrencyData.attach.fee}}</view>
			<view class="trade_fee_label price">{{getLangs('deposit')}}: ≈ {{getDepoit}}</view>
