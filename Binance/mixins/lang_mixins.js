...
const langsMixins = {
	methods: {
		async getLanguageHandler(){
			...
			this.$storage.setLocalData('langCnData', JSON.stringify(cn))
			this.$storage.setLocalData('langEnData', JSON.stringify(en))
			this.$storage.setLocalData('langCnsData', JSON.stringify(cns))
			this.$storage.setLocalData('langKoData', JSON.stringify(ko))
			this.$storage.setLocalData('langJaData', JSON.stringify(ja))
			this.$storage.setLocalData('langViData', JSON.stringify(vi))
			this.setCurrentLangLocalData()
		},
		/**
		 * 切换语言
