				...
				listData: {
					cn: [
						...
						},
						{
							title: '公司介绍',
							desc: `
							Biue集团是特币交易平台，获得真格基金、戴志康、红杉资本（苹果、亚马逊、阿里巴巴等众多全球知名公司股东）等A轮千万美金资本投资，BiueEX 执行严格风控管理，稳定运行。自BiueEX从2012年创立以来，截止到2020年末，BiueEX 累计成交额达5000亿美元，致力于区块链领域的核心技术突破以及区块链技术和产业融合。围绕区块链产业上下游，发展包括产业区块链、公链、数字资产交易、数字资产安全钱包、矿池、投资、孵化、研究等多业务板块，先后投资60+上下游企业，已形成全面的数字经济产业生态体系。Biue集团与阿根廷、俄罗斯、泰国、尼日利亚等多个国家开展区块链技术、应用领域合作，助推全球区块链应用落地。
							<br />
							Biue集团在全球多个地区拥有数字资产服务商合规牌照，在美国、日本、直布罗陀、泰国等12个国家和地区设有子公司或合伙公司，拥有超过3000名员工。Biue平台的数字资产交易规模已全球领先，为超过170+国家的千万级用户提供安全、可信赖的价值网络服务。    <br />                              
							2012年<br />
							09月 · Biue集团成立<br />
							2014年<br />
							04月 · 获得红杉资本投资    <br />                                                                                                                                                        
							12月 · 平台累计交易100亿美金，成为全球交易额最大的数字资产交易平台之一<br />
							2016年<br />
							12月 · BiueEX集团累计交易额达1200亿美金<br />
							2017年<br />
							10月 · 开启全球化战略布局， BiueEX韩国业务团队成立并正式投入运营<br />
							12月 · 完成 BiueEX日本公司布局，集团累计交易额突破2000亿美元<br />
							2018年<br />
							08月 · 收购香港主板上市公司桐成控股(01611.HK)<br />
							12月 · 集团累计交易额突破3000亿美元<br />
							2020年<br />
							06月 ·  Biue宣布金融公链计划——与Nervos基金会共同打造基于区块链的、全球性资产数字化及金融市场基础设施<br />`
						}
					],
					cns: [
						{
						...
						{   
							title: '公司介紹',
							desc: `
							Biue集團是特幣交易平台，獲得真格基金、戴誌康、紅杉資本（蘋果、亞馬遜、阿里巴巴等眾多全球知名公司股東）等A輪千萬美金資本投資，BiueEX 執行嚴格風控管理，穩定運行。自BiueEX從2012年創立以來，截止到2020年末，BiueEX 累計成交額達5000億美元，致力於區塊鏈領域的核心技術突破以及區塊鏈技術和產業融合。圍繞區塊鏈產業上下游，發展包括產業區塊鏈、公鏈、數字資產交易、數字資產安全錢包、礦池、投資、孵化、研究等多業務板塊，先後投資60+上下游企業，已形成全面的數字經濟產業生態體系。 Biue集團與阿根廷、俄羅斯、泰國、尼日利亞等多個國家開展區塊鏈技術、應用領域合作，助推全球區塊鏈應用落地。<br />
							Biue集團在全球多個地區擁有數字資產服務商合規牌照，在美國、日本、直布羅陀、泰國等12個國家和地區設有子公司或合夥公司，擁有超過3000名員工。 Biue平台的數字資產交易規模已全球領先，為超過170+國家的千萬級用戶提供安全、可信賴的價值網絡服務。<br />
							2012年<br />
							09月 · Biue集團成立<br />
							2014年<br />
							04月 · 獲得紅杉資本投資<br />
							12月 · 平台累計交易100億美金，成為全球交易額最大的數字資產交易平台之一<br />
							2016年<br />
							12月 · BiueEX集團累計交易額達1200億美金<br />
							2017年<br />
							10月 · 開啟全球化戰略佈局， BiueEX韓國業務團隊成立並正式投入運營<br />
							12月 · 完成 BiueEX日本公司佈局，集團累計交易額突破2000億美元<br />
							2018年<br />
							08月 · 收購香港主板上市公司桐成控股(01611.HK)<br />
							12月 · 集團累計交易額突破3000億美元<br />
							2020年<br />
							06月 · Biue宣布金融公鏈計劃——與Nervos基金會共同打造基於區塊鏈的、全球性資產數字化及金融市場基礎設施<br />
							`
						}
					],
					ja: [
						...
						{   
							...
							Biue Groupは特別な通貨取引プラットフォームであり、Zhen Fund、Dai Zhikang、Sequoia Capital（Apple、Amazon、Alibabaなどの多くの世界的に有名な企業の株主）などの設備投資で数千万ドルのラウンドAラウンドを獲得しています。BiueEXは厳格なリスク管理管理と安定した運用を実装しています。 。 BiueEXは2012年に設立されて以来、2020年末現在、5,000億米ドルの売上高を蓄積しており、ブロックチェーン分野におけるコアテクノロジーの飛躍的進歩とブロックチェーンテクノロジーと業界の統合に取り組んでいます。ブロックチェーン業界の上流と下流に焦点を当て、産業用ブロックチェーン、パブリックチェーン、デジタル資産取引、デジタル資産の安全なウォレット、マイニングプール、投資、インキュベーション、研究を含む複数のビジネスセクターを開発し、60以上の上流および下流の企業に継続的に投資して形成しました。包括的なデジタルエコノミー産業エコシステム。 Biue Groupは、グローバルなブロックチェーンアプリケーションの実装を促進するために、アルゼンチン、ロシア、タイ、ナイジェリア、およびその他の国とブロックチェーン技術およびアプリケーション分野で協力を行ってきました。 <br />
							Biue Groupは、世界中の多くの地域でデジタル資産サービスプロバイダーのコンプライアンスライセンスを取得しており、米国、日本、ジブラルタル、タイを含む12の国と地域に子会社またはパートナーシップを持ち、3,000人以上の従業員を擁しています。 Biueプラットフォームでのデジタル資産取引の規模は世界をリードし、170を超える国々の数千万人のユーザーに安全で信頼性の高いバリューネットワークサービスを提供しています。 <br />
							2012 <br />
							9月・Biueグループ設立<br/>
							2014 <br />
							4月・セコイア設備投資を取得<br/>
							12月・プラットフォームは累積で100億米ドルを取引し、取引量で世界最大のデジタル資産取引プラットフォームの1つになりました<br/>
							2016 <br />
							12月・BiueEXグループの累計取引高は1,200億米ドルに達した<br/>
							2017 <br />
							10月・グローバル戦略レイアウトを開始し、BiueEXコリアビジネスチームを設立し、正式に運用を開始<br />
							12月・BiueEX Japanのレイアウトを完了し、グループの累積取引量は2,000億米ドルを超えました<br/>
							2018 <br />
							8月・香港のメインボードに上場しているTongcheng Holdings（01611.HK）を買収。<br/>
							12月・グループの累積取引高は3,000億米ドルを超えました<br/>
							2020 <br />
							6月・Biueは、Nervos Foundationと協力して、ブロックチェーンベースのグローバルな資産デジタル化と金融市場インフラストラクチャを構築するための金融パブリックチェーン計画を発表しました<br/>
							`
						}
					],
					ko: [
						...
						{   
							title: '회사 프로필',
							desc: `						
                            Biue Group은 특별한 통화 거래 플랫폼으로 Zhen Fund, Dai Zhikang, Sequoia Capital (Apple, Amazon, Alibaba 등 세계적으로 유명한 기업의 주주) 등 수천만 달러의 자본 투자 라운드를 받았습니다. BiueEX는 엄격한 리스크 관리와 안정적인 운영을 구현합니다. . BiueEX는 2012 년에 설립 된 이래 2020 년 말 기준으로 5,000 억 달러의 매출을 기록했으며 블록 체인 분야의 핵심 기술 혁신과 블록 체인 기술과 산업의 통합을 위해 최선을 다하고 있습니다. 블록 체인 산업의 업스트림 및 다운 스트림에 초점을 맞추고 산업 블록 체인, 퍼블릭 체인, 디지털 자산 거래, 디지털 자산 보안 지갑, 채굴 풀, 투자, 인큐베이션, 연구 등을 포함한 여러 비즈니스 부문을 개발했으며 60 개 이상의 업스트림 및 다운 스트림 회사에 연속적으로 투자하여 형성했습니다. 포괄적 인 디지털 경제 산업 생태계. Biue Group은 글로벌 블록 체인 애플리케이션의 구현을 촉진하기 위해 블록 체인 기술 및 애플리케이션 분야에서 아르헨티나, 러시아, 태국, 나이지리아 및 기타 국가와 협력했습니다.
                            <br /> 2012 년 <br />
                            9 월 ・ Biue グ ル ー 프 설립 <br/>
                            2014 년 <br />
                            4 월 ・ 2 차 장비 투자 인수 <br/>
                            12 월 ・ 플랫 토포 무는 100 억 미터를 모으고 있습니다.
                            2016 년 <br />
                            12 월 ・ BiueEX グ ル ー プ의 누적 取 引 高 は 1,200 억 미터 ド ル に 达 し た <br/>
                            2017 년 <br />
                            10 월 ・ 그로 바르 戦 略 レ イ ア ウ ト ウ ト ウ ト ウ ト ウ ト ウ ト を し 、 BiueEX コ リ ア ビ ジ ネ ス チ ー ム을 설립 、 공식 운영 개시 <br />
                            12 월 ・ BiueEX Japan의 레이 아우트를 終了 し 、 グ ル ー プ의 누적 인출 액은 2,000 억 미터 ド ル を 超 え ま し た <br/>
                            2018 년 <br />
                            8 월, 홍콩의 メ イ ン ボ ー ド に 上场 し て い る Tongcheng Holdings (01611.HK)를 인수했습니다. <br/>
                            12 월 ・ 그 루프의 높은 は 3,000 억 미터의 누적 컬렉션 ド ル を 超 え ま し た <br/>
                            2020 년 <br />
                            6 월 ・ Biue は 、 Nervos Foundation와 합력 해 、 브록 크첸베이스 노 그로 바르 인 資料 데지 탈화 금융 시장으로
							`
						}
					],
					vi: [
						...
						{   
							title: 'Hồ sơ công ty',
							desc: `						
						    Biue Group là một sàn giao dịch tiền tệ đặc biệt, đã thu được vốn đầu tư vòng A hàng chục triệu USD như Zhen Fund, Dai Zhikang, Sequoia Capital (cổ đông của nhiều công ty nổi tiếng thế giới như Apple, Amazon, Alibaba, v.v.) BiueEX thực hiện quản lý kiểm soát rủi ro chặt chẽ và hoạt động ổn định . Kể từ khi BiueEX được thành lập vào năm 2012, tính đến cuối năm 2020, BiueEX đã tích lũy được doanh thu 500 tỷ đô la Mỹ, đồng thời cam kết mang lại những đột phá công nghệ cốt lõi trong lĩnh vực blockchain và tích hợp công nghệ và công nghiệp blockchain. Tập trung vào thượng nguồn và hạ nguồn của ngành công nghiệp blockchain, nó đã phát triển nhiều lĩnh vực kinh doanh bao gồm blockchain công nghiệp, chuỗi công khai, giao dịch tài sản kỹ thuật số, ví bảo mật tài sản kỹ thuật số, nhóm khai thác, đầu tư, ươm tạo và nghiên cứu, và liên tiếp đầu tư vào hơn 60 công ty thượng nguồn và hạ nguồn, và đã hình thành Một hệ sinh thái công nghiệp kinh tế kỹ thuật số toàn diện. Tập đoàn Biue đã hợp tác với Argentina, Nga, Thái Lan, Nigeria và các quốc gia khác trong lĩnh vực ứng dụng và công nghệ blockchain để thúc đẩy việc triển khai các ứng dụng blockchain toàn cầu.
							<br />
							Tập đoàn Biue có giấy phép tuân thủ nhà cung cấp dịch vụ tài sản kỹ thuật số ở nhiều khu vực trên thế giới và có các công ty con hoặc quan hệ đối tác ở 12 quốc gia và khu vực bao gồm Hoa Kỳ, Nhật Bản, Gibraltar và Thái Lan, và có hơn 3.000 nhân viên. Quy mô giao dịch tài sản kỹ thuật số trên nền tảng Biue đã dẫn đầu thế giới, cung cấp các dịch vụ mạng giá trị an toàn và đáng tin cậy cho hàng chục triệu người dùng tại hơn 170 quốc gia.
							<br />
							2012 <br />
							Tháng 9 · Biue Group được thành lập <br />
							2014 <br />
							Tháng 4 · Thu được Đầu tư Vốn Sequoia <br />
							Tháng 12 · Nền tảng này đã giao dịch tích lũy được 10 tỷ đô la Mỹ, trở thành một trong những nền tảng giao dịch tài sản kỹ thuật số lớn nhất thế giới tính theo khối lượng giao dịch <br />
							2016 <br />
							Tháng 12 · Khối lượng giao dịch tích lũy của BiueEX Group đạt 120 tỷ đô la Mỹ <br />
							2017 <br />
							Tháng 10 · Khai trương bố cục chiến lược toàn cầu, nhóm kinh doanh BiueEX Hàn Quốc được thành lập và chính thức đi vào hoạt động <br />
							Tháng 12 · Hoàn thành việc bố trí BiueEX Japan và khối lượng giao dịch tích lũy của tập đoàn đã vượt quá 200 tỷ đô la Mỹ <br />
							2018 <br />
							Tháng 8 · Mua lại Tongcheng Holdings (01611.HK), một công ty được niêm yết trên Hội đồng quản trị chính của Hồng Kông. <br />
							Tháng 12 · Khối lượng giao dịch tích lũy của nhóm vượt 300 tỷ đô la Mỹ <br />
							2020 <br />
							Tháng 6 · Biue đã công bố kế hoạch chuỗi công khai tài chính - cùng với Nervos Foundation để xây dựng cơ sở hạ tầng thị trường tài chính và số hóa tài sản toàn cầu dựa trên blockchain <br />
							`
						}
					],
					en: [
						...
						{   
							...
							desc: `
							Biue Group is a special currency trading platform. It has obtained a round A round of tens of millions of dollars in capital investment such as Zhen Fund, Dai Zhikang, Sequoia Capital (shareholders of many world-renowned companies such as Apple, Amazon, Alibaba, etc.). BiueEX implements strict risk management and stable operation . Since BiueEX was founded in 2012, as of the end of 2020, BiueEX has accumulated a turnover of 500 billion U.S. dollars, and is committed to core technology breakthroughs in the blockchain field and the integration of blockchain technology and industry. Focusing on the upstream and downstream of the blockchain industry, it has developed multiple business sectors including industrial blockchain, public chains, digital asset transactions, digital asset secure wallets, mining pools, investment, incubation, research, etc., and successively invested in 60+ upstream and downstream companies, and has formed Comprehensive digital economy industrial ecosystem. Biue Group has cooperated with Argentina, Russia, Thailand, Nigeria and other countries in the field of blockchain technology and application to help promote the implementation of global blockchain applications.
							<br />
							Biue Group has digital asset service provider compliance licenses in many regions around the world, and has subsidiaries or partnerships in 12 countries and regions including the United States, Japan, Gibraltar, and Thailand, and has more than 3,000 employees. The scale of digital asset transactions on the Biue platform has led the world, providing safe and reliable value Biueork services for tens of millions of users in more than 170+ countries.
							2012<br />
							September · Biue Group was established<br />
							2014<br />
							April · Obtained Sequoia Capital Investment<br />
							December · The platform has accumulatively traded 10 billion U.S. dollars, becoming one of the world's largest digital asset trading platforms by transaction volume<br />
							2016<br />
							December · BiueEX Group's cumulative transaction volume reached 120 billion U.S. dollars<br />
							2017<br />
							October · Opened the global strategic layout, BiueEX Korea business team was established and officially put into operation<br />
							December · Completed the layout of BiueEX Japan, and the group's cumulative transaction volume exceeded US$200 billion<br />
							2018<br />
							August · Acquired Tongcheng Holdings (01611.HK), a listed company on the main board of Hong Kong,<br />
							December · The group's cumulative transaction volume exceeded US$300 billion<br />
							2020<br />
							June · Biue announced the financial public chain plan-together with the Nervos Foundation to build a blockchain-based, global asset digitization and financial market infrastructure<br />
							`
						}
					]
				}
