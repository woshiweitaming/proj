			...
			<view class="labels" v-for="(items, index) in getCoinInfoData.financeList" :key="index">
				...
				<view class="fd">
					<view class="items">
						...
						<view class="value">{{items.money_scope && formatNumber(Number(items.money_scope.split('~')[0]))}}~{{items.money_scope && formatNumber(Number(items.money_scope.split('~')[1]))}}</view>
					</view>
					<view class="items">
					...
					<view class="items">
						...
						<view class="value">{{items.pro_period}}</view>
					</view>
				</view>
			</view>
		</view>
