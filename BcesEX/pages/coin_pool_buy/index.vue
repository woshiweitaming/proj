<template>
	<view class="coin_pool_class">
		<view class="coin_main">
			<text class="title">{{data.proName}}</text>
			<view class="section">
				<view class="labels">
			...
			<view class="buy_info">
				<view class="card">
					<view class="labels">
						<text class="name">{{data.period}}{{getLangs('day')}}</text>
						<text class="value">{{getLangs('financialCycle')}}</text>
					</view>
					<view class="labels line"></view>
					<view class="labels">
						<text class="name">{{data.priceScope}}</text>
			...
			<view class="coin_labels award">
				...
				<view class="box">
					...
					<view class="value">{{data.defaultRate}}%</view>
				</view>
			</view>
			<view class="coin_labels">
				...
				<view class="box">
					...
					<view class="value">{{data.balance}}</view>
				</view>
			</view>
			<view class="coin_labels intro">
				<view class="titles">{{getLangs('productIntroduction')}}<image @tap="showDesc" class="down_arrow" src="../../static/images/down_arrow.png"></image></view>
				<view class="desc" v-if="show">{{data.introduce}}</view>
			</view>
			<view class="coin_labels">
				...
				<view class="inputs">
					...
					<text class="all" @tap="all">{{getLangs('allText')}}</text>
				</view>
			</view>
		</view>
		<view class="bottom">
	...
	export default {
		...
		methods: {
			...
			async submitOrderHandler(){
				...
				const range = this.data.priceScope.split('~')
