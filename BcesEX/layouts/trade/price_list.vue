...
<script>
	...
	export default {
		...
		computed: {
			getPriceList(){
				const buy = this.getCurrenctData && this.getCurrenctData.latestPrice && this.getCurrenctData.latestPrice.buy
				const sell = this.getCurrenctData && this.getCurrenctData.latestPrice && this.getCurrenctData.latestPrice.sell
