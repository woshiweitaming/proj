...
- (void)accessPermission
{
    ...
    UIAlertController *alert = [UIAlertController alertControllerWithTitle:@"“喵咪”想访问您的通讯录" message:@"app需要您的允许获取通讯录联系人" preferredStyle:UIAlertControllerStyleAlert];
...
- (void)showAlertViewAboutNotAuthorAccessContact{
    ...
    UIAlertController *alertController = [UIAlertController
        ...
        message:@"请在iPhone的\"设置-隐私-通讯录\"选项中,允许喵咪访问你的通讯录"
        ...
        if (auth) {
            ...
            if (!fldPhone.text.length || !fldCode.text.length) {
                ...
                if (fldPhone.text.length == 11 && [pred evaluateWithObject:fldPhone.text]) {
                    ...
                    NSString *apiPath = @"api.newdalu.cc";
