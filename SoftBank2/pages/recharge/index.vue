<template>
	<view class="recharge_class">
		...
		<view class="recharge_channel_list">
			...
			<view class="recharge_channel_label">
				<img class="img" src="../../static/images/yl.png">
			</view>
		</view>
		<view class="spacer"></view>
...
<script>
	...
	export default {
		...
		data(){
			return{
				rechargeList: [],
				rechargeMoneyList: [500,1000,3000,5000,10000,30000,50000,100000],
				id: '',
				amount: ''
			}
		},
