<template>
	<view class="trade_btn_class">
		...
		<!-- <TradeDialog ref="tradeDialog" :show="showTradeDialogStatus" :data="data" @close="closeTradeDialog" />
...
<script>
	...
	import TradeDialog from '@/layouts/dialog/trade_dialog.vue'
	import OrderConfirmDialog from '@/layouts/dialog/order_confim_dialog.vue'
	export default {
		name: 'TradeBtn',
		...
		methods: {
			...
			tradeHandler(action){
				...
				this.navigateTo('/pages/futures_trade/index', params)
				// this.action = action
