<template>
	<view class="wallet_class">
		<!-- <view class="header">
			<view class="title">
			   {{getLangs('recharging')}}
			   <image @click="toBack" mode="widthFix" src="../../static/images/left_arrow.png" class="arrow"></image>
			   <image src="../" @click="toKefu" class="kefu">{{getLangs('onlineService')}}</text>
			</view>
		</view> -->
		...
		<view class="linked_main">
		    ...
		    <view class="tips">
		    	<rich-text :nodes="getLangs('kefutip2')"></rich-text>
		    </view>
		</view>
