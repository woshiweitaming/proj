<template>
		<view class="currency_list">
			<view class="currency_list_label" @click="toPage(curItem.id, curItem.name, curItem.fromcid)" v-for="(curItem, index) in currencyList.length > 0 ? currencyList : getQuotation" :key="index">
				<view class="label">
