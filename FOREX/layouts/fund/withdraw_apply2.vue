	...
	<view class="form_class">
		<view class="withdraw_content">
			...
			<view class="form_label">
				...
				<view class="form_label_main">
					<view class="form_input_bar">
						<input type="text" :disabled="disabled" class="input_bar" :placeholder="getLangs('bankAccountNumber')" v-model="params.banknumber" />
					</view>
				</view>
			</view>
			<view class="form_label">
				...
				<view class="form_label_main">
					<view class="form_input_bar">
						<input type="text" :disabled="disabled" class="input_bar" :placeholder="getLangs('customerName')" v-model="params.name" />
					</view>
				</view>
			</view>
			<view class="form_label">
				...
				<view class="form_label_main">
					<view class="form_input_bar">
						<input type="text" :disabled="disabled" class="input_bar" :placeholder="getLangs('bankName')" v-model="params.bankname" />
					</view>
				</view>
			</view>
			<view class="form_label">
				...
				<view class="form_label_main">
					<view class="form_input_bar">
						<input type="text" :disabled="disabled" class="input_bar" :placeholder="getLangs('bankAddress')" v-model="params.badds" />
					</view>
				</view>
			</view>
...
<script>
	...
	export default {
		...
		methods:{
			...
			async init(){
				tips.showLoading(this.getLangs('loadingText'))
				const res = await getWinConfig()
				this.config = res.data
				const bankInfo = await getBankInfo()
				tips.hideLoading()
				if(bankInfo.data.banknumber !== ''){
					this.params.banknumber = bankInfo.data.banknumber
					this.params.bankname= bankInfo.data.bankname
					this.params.name = bankInfo.data.bname
					this.params.badds = bankInfo.data.badds
					this.disabled = true
				}
			},
		},
