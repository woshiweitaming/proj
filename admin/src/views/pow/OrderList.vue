        ...
        <div class="query_class">
            <div class="query_data_class">
                ...
                <div class="query_items">
                    <div class="query_label">
                        <span>矿机开始时间</span>
                        <el-date-picker clearable class="input_date_bar" size="mini" v-model="params.beginDate" type="date" format="yyyy-MM-dd" value-format="yyyy-MM-dd" placeholder="开始时间">
                        </el-date-picker>
                    </div>
                </div>
                <div class="query_items">
                    <div class="query_label">
                        <span>矿机到期时间</span>
                        <el-date-picker clearable class="input_date_bar" size="mini" v-model="params.endDate" type="date" format="yyyy-MM-dd" value-format="yyyy-MM-dd" placeholder="结束时间">
                        </el-date-picker>
                    </div>
                </div>
                <div class="query_items">
...
export default {
    ...
    methods: {
        async search() {
            ...
            params.beginDate = this.toStartDate(this.params.beginDate)
            params.endDate = this.toStartDate(this.params.endDate)
