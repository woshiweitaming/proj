            ...
            <div class="query_class">
                <div class="query_data_class">
                    ...
                    <div class="query_items">
                        <div class="query_label" >
                            <span>操作人</span>
                            <el-input clearable type="text" class="input_bar" v-model="params.operator" size="mini"></el-input>
                        </div>
                    </div>
                    <div class="query_items">
                        <div class="query_label" >
                    ...
                    >
                        ...
                        >
                            <template slot-scope="scope">
                                <span :class="scope.row.price > 0 ? 'green' : 'red'">{{scope.row.price}}</span>
                            </template>  
                        </el-table-column>
                        <el-table-column
                            prop="explain"
...
import { getPayLogList} from '@/api/admins'
...
export default {
    ...
    methods: {
        ...
        async search(){
            ...
            const res = await getPayLogList(params)
