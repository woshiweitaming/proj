...
<script>
	...
	export default {
		...
		computed: {
			getPriceList(){
				const buy = this.getCurrentCurrencyData && this.getCurrentCurrencyData.latestPrice && this.getCurrentCurrencyData.latestPrice.buy
				const sell = this.getCurrentCurrencyData && this.getCurrentCurrencyData.latestPrice && this.getCurrentCurrencyData.latestPrice.sell
				if(typeof buy === 'undefined' || typeof sell === 'undefined') return []
				const data = [buy, sell]
				return data
